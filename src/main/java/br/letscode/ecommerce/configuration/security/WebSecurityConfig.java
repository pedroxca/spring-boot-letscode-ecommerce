...
import br.letscode.ecommerce.configuration.security.jwt.JWTAuthenticationFilter;
import br.letscode.ecommerce.configuration.security.jwt.JWTAuthorizationFilter;
import br.letscode.ecommerce.configuration.security.userConfig.UserServiceImpl;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        // Criacao do AuthenticationManager, servico que cuida das autenticacoes. No
